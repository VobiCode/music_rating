...
def update_score():
    ...
    atmosphere_bonus = round(main_score * (0.125 + sliders[4].get() * 0.1))
    trend_bonus = round(main_score * (0.125 + sliders[5].get() * 0.1))
    total_score = main_score + atmosphere_bonus + trend_bonus

    atmosphere_percent = int((0.125 + sliders[4].get() * 0.1) * 100)
    trend_percent = int((0.125 + sliders[5].get() * 0.1) * 100)
