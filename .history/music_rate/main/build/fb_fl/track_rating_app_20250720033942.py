...
def update_score():
    ...
    atmosphere_bonus = round(main_score * (0.05 + sliders[4].get() * 0.05))
    trend_bonus = round(main_score * (0.05 + sliders[5].get() * 0.05))
...
def calculate_score():
    ...
    main_score = sum(slider.get() for slider in sliders[:4])
    atmosphere_bonus = round(main_score * (sliders[4].get() * 0.05))
    trend_bonus = round(main_score * (sliders[5].get() * 0.05))
    total_score = main_score + atmosphere_bonus + trend_bonus
